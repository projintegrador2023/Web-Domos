        ...
        <section class="mx-auto mt-4 col-12 col-sm-8 col-lg-7 col-xl-5 d-block">
            <form class="">
                <div class="formulario mx-3 px-5 py-4" id="div_cadastro_morador">
                    ...
                    <input class="bg-e8e8e8 col-12 fs-5 input-form" id="nome_usuario" type="text" required maxlength="45"><br>
                    ...
                    <input class="bg-e8e8e8 col-12 fs-5 input-form" id="cpf_usuario" type="text" required><br>
                    ...
                    <input class="bg-e8e8e8 col-12 fs-5 input-form" id="email_usuario" type="email" required><br>
                    ...
                    <input class="bg-e8e8e8 col-12 fs-5 input-form" id="senha_usuario" type="password" required> <br>
                    ...
                    <input class="bg-e8e8e8 col-12 fs-5 input-form" id="conf_senha_usuario" type="password" required><br>
                ...
                <div class="formulario mx-3 px-5 py-4 d-none" id="div_informacoes_condominio">
                    <div class="d-flex align-items-center">
                        ...
                        <h1 class="color-0491a3 ms-4 fs-2 text-center"> Informações do condomínio </h1>
                    </div>


                    <div class="my-3">
                        <label for="input_codigo_condominio" id="label_codigo_condominio" class="fs-5 color-0491a3"> Código do condomínio*</label>
                        <input id="input_codigo_condominio" class="bg-e8e8e8 col-12 fs-5 input-form" type="text" maxlength="6" required>  <br>
                    ...
                    <div class="text-end col-12 pt-4">
                        <button type="button" class="bg-005661 color-fff p-2 rounded border-0 col-12 col-md-6 col-xxl-3 hover-0491a3" onclick="validacao_cadastro_usuario()"> Cadastrar </button>
                    </div>
                </div>
            </form>
            </div>         
