    ...
    <div class="grid-container">
      ...
      <!-- Navegação em abas pela barra lateral (sidebar)>
        ...
        <main container class="main-container">
            <div class="d-flex justify-content-center row m-1 col-12">
                <div class="col-lg-4 col-6 d-flex flex-column align-items-center align-items-lg-end mx-4">
                    ...
                    <button class="btn bg-0491a3 hover-0dc0d8 mt-3 mx-2 col-5 text-white" ><i class="fa-solid fa-user-pen flex-grow-1"></i> Editar perfil </button>
                    <?php 
