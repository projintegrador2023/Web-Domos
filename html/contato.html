    ...
    <div class="fundo-imagem">
        ...
        <section class="contatos">
            ...
            <section class="m-auto text-center">
                <h1 class="text-white fs-1 mb-5"> Contatos </h1>
            </section>

            <!-- "Fichas" com o conteúdo -->
            <div class="hover-0491a3 bg-005661 m-auto d-flex justify-content-center align-items-center mb-3 col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 p-3 rounded-4">
                <i class="fa-solid fa-envelope color-fdfdfd fs-3"></i>
                <p class="m-0 ps-2 fs-4 fw-200"> projintegrador.domos@gmail.com </p> 
            </div>
            <div class="hover-0491a3 bg-005661 m-auto d-flex justify-content-center align-items-center mb-3 col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 p-3 rounded-4">
                <i class="fa-solid fa-phone color-fdfdfd fs-3"></i>
                <p class="m-0 ps-2 fs-4 fw-200">(27)3066-0633 </p> 
            </div>
            <div class="hover-0491a3 bg-005661 m-auto d-flex justify-content-center align-items-center mb-3 col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 p-3 rounded-4">
                <i class="fa-brands fa-whatsapp color-fdfdfd fs-2"></i>
                <p class="m-0 ps-2 fs-4 fw-200"> (27)996517829</p> 
            </div>
            
            <div class="col-11 col-sm-9 col-md-7 col-lg-5 col-xl-4 m-auto">
                <a class="text-decoration-none text-center w-25" href="https://www.instagram.com/domosoficial/">
                    <div class="hover-0491a3 bg-005661 m-auto d-flex justify-content-center align-items-center text-center col-12 p-3 rounded-4">
                        <i class="fa-brands fa-instagram color-fdfdfd fs-2"></i>
