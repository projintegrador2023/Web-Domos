        ...
        <div class="col-12 d-flex justify-content-between">
            <form>
                ...
                <div class="formulario col-5 p-5">
                    ...
                    <div class="mb-5">
                        <label for="nome_divisao" class="form-label color-0491a3 fs-4">Digite os números das casas / apartamentos separados por ponto e vírgula (;)*:</label>
                        <textarea class="form-control p-3 fs-4" id="nome_divisao" placeholder="Exemplo: 101;102;103;104;201;202;203;204" rows="3"></textarea>
                    </div>
                    <div class="mb-5">
                    ...
                    <h3 class="color-0491a3 text-center fs-3 mb-4">Informações dos espaços públicos (opcional)</h3>
                    ...
                    <div class="text-end col-12">
                        <button class="bg-005661 color-fff p-2 rounded border-0 button_formulario col-5 fs-3 hover-0491a3"> Cadastrar </button>
                    </div>
                </div>
            </form>
        </div>
