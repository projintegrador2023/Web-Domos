...
if(autenticar($db_con)) {
	...
	if (isset($_POST['titulo']) && isset($_POST['tag']) && isset($_POST['descricao']) && isset($_POST['cpf'])) {
		...
		$consulta = $db_con->prepare("INSERT INTO anuncio(data_hora_postagem, descricao, titulo, fk_usuario_cpf, fk_tag_codigo_tag, fk_condominio_codigo_condominio) VALUES('$data_hora_formatada', '$descricao', '$titulo', '$cpf','$tag', '$codigo_condominio')");
		if ($consulta->execute()) {
