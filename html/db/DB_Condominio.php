    ...
    class Condominio extends CRUD{
        ...
        ***************/
        public function update($id){
            $sql="UPDATE $this->table SET nome = :nome, email = :email , senha = :senha, fk_tipo_moradia_codigo_tipo_moradia = :fk_tipo_moradia_codigo_tipo_moradia  WHERE codigo_condominio = :codigo_condominio ";
            $stmt = Database::prepare($sql);
            $stmt->bindParam(':nome', $this->nome);
            $stmt->bindParam(':email', $this->email);
            $stmt->bindParam(':senha', $this->senha);
