...
<body>
    <div class="fundo-imagem">
        ...
        <!-- Formulário de login --> 
        <section class="d-block mx-auto col-8 col-md-6 col-lg-5 col-xl-4 p-4 rborder4 formulario">
            ...
            <div class="pe-2 text-end">
                <a href="recuperar_senha.html" class="color-0491a3"> Esqueceu sua senha? </a> 
            </div> <br> 
